...
AntChain Bridg是蚂蚁链开源的区块链之间的可信通信网络，我们致力于打造通用的异构链跨链协议，为Web3世界打造可信通信的基础设施。
...
- **AntChainBridgePluginSDK**：提供开发者开发AntChain Bridge应用的所有工具，详情参考[README](acb-sdk/README.md)；
- **AntChainBridgeRelayer**：网络中负责监听、传递跨链消息的中继服务，向区块链提供加入AntChain Bridge的入口，详情参考[README](acb-relayer/README.md)；
